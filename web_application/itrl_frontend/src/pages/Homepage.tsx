...
import bgimg from "../assets/hmpic.jpg";
        ...
        <div style={contentStyle}>
          ...
          <div style={textContainerStyle}>
            ...
            <div style={descriptionStyle}>
              ಕಲಿಕೆ ಮೇಟ್ ಎನ್ನುವುದು ಸಂವಾದಾತ್ಮಕ ಕಲಿಕೆಯ ಸಾಧನವಾಗಿದ್ದು,
              ವಿದ್ಯಾರ್ಥಿಗಳಿಗೆ ಕನ್ನಡದಲ್ಲಿ ಕೋಡಿಂಗ್ ಕಲಿಯಲು ಸಹಾಯ ಮಾಡಲು
              ವಿನ್ಯಾಸಗೊಳಿಸಲಾಗಿದೆ. ಇದು ಸ್ವಯಂ ಗತಿಯ ಮತ್ತು ಬಳಕೆದಾರ ಸ್ನೇಹಿ
              ಪರಿಸರವಾಗಿದೆ. ಈ ವೆಬ್ ಅಪ್ಲಿಕೇಶನ್‌ನ ಉದ್ದೇಶವು ವಿದ್ಯಾರ್ಥಿಗಳಲ್ಲಿ ಕೋಡಿಂಗ್
              ಕೌಶಲ್ಯ ಮತ್ತು ವಿಶ್ಲೇಷಣಾತ್ಮಕ ಚಿಂತನೆಯನ್ನು ಬೆಳೆಸುವುದು. ಹ್ಯಾಪಿ ಕೋಡಿಂಗ್!
            </div>
